...
?[](https://github.com/Masub27/A1-German-Tool/blob/main/Audio_Test/E.mp3?raw=true)
...
Hallo! Ich bin Lea. Ich komme aus Split. Ich lerne Deutsch. Bojan kommt aus Warna.

1. Lea kommt aus Warna 

   [[ ]] richtig
   [[x]] falsch

2. Bojan kommt aus Warna 
...
(() => {
  ...
  btnYes.addEventListener("click", () => {
    disableAll();
    say("🎉 Congratulations!");
    say("✅ You have completed easy level.");
    say("🎯 You are now ready to move next moderate level.");
    showLinks(`
  ...
  btnNo.addEventListener("click", () => {
    disableAll();
    say("💡 No worries — this  level is quite challenging.");
    say("📌 My honest suggestion: you should try very easy level and then move to easy level again.");
    say("🔁 Or repeat the same easy level once more.");
    showLinks(`
