...
?[](https://github.com/Masub27/A1-German-Tool/blob/main/Audio_Test/D.mp3?raw=true)
...
Piotr und Stefan kommen aus Berlin. Sie studieren in Kapstadt.
...
(() => {
  ...
  btnYes.addEventListener("click", () => {
    disableAll();
    say("🎉 Congratulations!");
    say("✅ You have completed Very Difficult level.");
    say("🎯 You are now ready for assessment.");
    showLinks(`
  ...
  btnNo.addEventListener("click", () => {
    disableAll();
    say("💡 No worries — this very difficulty level is quite challenging.");
    say("📌 My honest suggestion: you should try Difficult and then move to Very Difficult again.");
    say("🔁 Or repeat the same very difficulty level once more.");
    showLinks(`
